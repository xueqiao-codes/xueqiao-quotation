            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tradeAddresses = new ArrayList<AccessAddress>(_list58.size);
                for (int _i59 = 0; _i59 < _list58.size; ++_i59)
                {
                  AccessAddress _elem60;
                  _elem60 = new AccessAddress();
                  _elem60.read(iprot);
                  struct.tradeAddresses.add(_elem60);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.customInfoMap = new HashMap<String,String>(2*_map61.size);
                for (int _i62 = 0; _i62 < _map61.size; ++_i62)
                {
                  ...
                  struct.customInfoMap.put(_key63, _val64);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.quotaAddresses = new ArrayList<AccessAddress>(_list65.size);
                for (int _i66 = 0; _i66 < _list65.size; ++_i66)
                {
                  AccessAddress _elem67;
                  _elem67 = new AccessAddress();
                  _elem67.read(iprot);
                  struct.quotaAddresses.add(_elem67);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tradeAddresses != null) {
        if (struct.isSetTradeAddresses()) {
          oprot.writeFieldBegin(TRADE_ADDRESSES_FIELD_DESC);
          {
            ...
            for (AccessAddress _iter68 : struct.tradeAddresses)
            {
              _iter68.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.customInfoMap != null) {
        if (struct.isSetCustomInfoMap()) {
          oprot.writeFieldBegin(CUSTOM_INFO_MAP_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter69 : struct.customInfoMap.entrySet())
            {
      ...
      if (struct.quotaAddresses != null) {
        if (struct.isSetQuotaAddresses()) {
          oprot.writeFieldBegin(QUOTA_ADDRESSES_FIELD_DESC);
          {
            ...
            for (AccessAddress _iter70 : struct.quotaAddresses)
            {
              _iter70.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetTradeAddresses()) {
        {
          ...
          for (AccessAddress _iter71 : struct.tradeAddresses)
          {
            _iter71.write(oprot);
          }
        }
      ...
      if (struct.isSetCustomInfoMap()) {
        {
          ...
          for (Map.Entry<String, String> _iter72 : struct.customInfoMap.entrySet())
          {
      ...
      if (struct.isSetQuotaAddresses()) {
        {
          ...
          for (AccessAddress _iter73 : struct.quotaAddresses)
          {
            _iter73.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.tradeAddresses = new ArrayList<AccessAddress>(_list74.size);
          for (int _i75 = 0; _i75 < _list74.size; ++_i75)
          {
            AccessAddress _elem76;
            _elem76 = new AccessAddress();
            _elem76.read(iprot);
            struct.tradeAddresses.add(_elem76);
          }
        }
        struct.setTradeAddressesIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.customInfoMap = new HashMap<String,String>(2*_map77.size);
          for (int _i78 = 0; _i78 < _map77.size; ++_i78)
          {
            ...
            struct.customInfoMap.put(_key79, _val80);
          }
        }
        struct.setCustomInfoMapIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.quotaAddresses = new ArrayList<AccessAddress>(_list81.size);
          for (int _i82 = 0; _i82 < _list81.size; ++_i82)
          {
            AccessAddress _elem83;
            _elem83 = new AccessAddress();
            _elem83.read(iprot);
            struct.quotaAddresses.add(_elem83);
          }
        }
        struct.setQuotaAddressesIsSet(true);
      }
