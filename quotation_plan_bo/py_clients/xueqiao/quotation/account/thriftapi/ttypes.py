...
class QuotationAccountSubscribe:
  """
  Attributes:
   - accountId
   - sledCommodityId
  ...
  thrift_spec = (
    ...
    (3, TType.I32, 'sledContractId', None, None, ), # 3
    (4, TType.BOOL, 'isActiveMonth', None, None, ), # 4
    (5, TType.I32, 'platformEnv', None, None, ), # 5
    (6, TType.I64, 'createTimestamp', None, None, ), # 6
    (7, TType.I64, 'lastModifyTimestamp', None, None, ), # 7
    (8, TType.I32, 'sledExchangeId', None, None, ), # 8
  )

  def __init__(self, accountId=None, sledCommodityId=None, sledContractId=None, isActiveMonth=None, platformEnv=None, createTimestamp=None, lastModifyTimestamp=None, sledExchangeId=None,):
    self.accountId = accountId
    self.sledCommodityId = sledCommodityId
    self.sledContractId = sledContractId
    self.isActiveMonth = isActiveMonth
    self.platformEnv = platformEnv
    self.createTimestamp = createTimestamp
    self.lastModifyTimestamp = lastModifyTimestamp
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.BOOL:
          self.isActiveMonth = iprot.readBool();
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.I32:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('QuotationAccountSubscribe')
    if self.accountId is not None:
      oprot.writeFieldBegin('accountId', TType.I64, 1)
      oprot.writeI64(self.accountId)
      oprot.writeFieldEnd()
    ...
    if self.sledContractId is not None:
      oprot.writeFieldBegin('sledContractId', TType.I32, 3)
      oprot.writeI32(self.sledContractId)
      oprot.writeFieldEnd()
    if self.isActiveMonth is not None:
      oprot.writeFieldBegin('isActiveMonth', TType.BOOL, 4)
      oprot.writeBool(self.isActiveMonth)
      oprot.writeFieldEnd()
    if self.platformEnv is not None:
      oprot.writeFieldBegin('platformEnv', TType.I32, 5)
      oprot.writeI32(self.platformEnv)
    ...
    if self.createTimestamp is not None:
      ...
      oprot.writeFieldEnd()
    if self.lastModifyTimestamp is not None:
      oprot.writeFieldBegin('lastModifyTimestamp', TType.I64, 7)
      oprot.writeI64(self.lastModifyTimestamp)
      oprot.writeFieldEnd()
    if self.sledExchangeId is not None:
      oprot.writeFieldBegin('sledExchangeId', TType.I32, 8)
...
class QuotationAccountSubscribePage:
  """
  Attributes:
   - total
   - page
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I32, 'total', None, None, ), # 1
    (2, TType.LIST, 'page', (TType.STRUCT,(QuotationAccountSubscribe, QuotationAccountSubscribe.thrift_spec)), None, ), # 2
  )
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i52 in xrange(_size48):
            _elem53 = QuotationAccountSubscribe()
            _elem53.read(iprot)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('QuotationAccountSubscribePage')
    if self.total is not None:
      oprot.writeFieldBegin('total', TType.I32, 1)
      oprot.writeI32(self.total)
      oprot.writeFieldEnd()
...
class ReqQuotationAccountSubscribeOption:
  """
  Attributes:
   - accountId
   - sledCommodityId
  ...
  def __init__(self, accountId=None, sledCommodityId=None, platformEnv=None,):
    self.accountId = accountId
    self.sledCommodityId = sledCommodityId
    self.platformEnv = platformEnv
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('ReqQuotationAccountSubscribeOption')
    if self.accountId is not None:
      oprot.writeFieldBegin('accountId', TType.I64, 1)
      oprot.writeI64(self.accountId)
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i59 in xrange(_size55):
            _elem60 = AccountCommodityRegisterAbility()
            _elem60.read(iprot)
            self.page.append(_elem60)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class ReqAccountCommodityRegisterAbilityOption:
      ...
      if fid == 1:
        ...
        if ftype == TType.SET:
          ...
          for _i66 in xrange(_size62):
            ...
            self.sledCommodityIds.add(_elem67)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.SET:
          ...
          for _i72 in xrange(_size68):
            ...
            self.sledExchangeIds.add(_elem73)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.sledCommodityIds is not None:
      ...
      for iter80 in self.sledCommodityIds:
    ...
    if self.sledExchangeIds is not None:
      ...
      for iter81 in self.sledExchangeIds:
    ...
    if self.exchangeMics is not None:
      ...
      for iter82 in self.exchangeMics:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i101 in xrange(_size97):
            _elem102 = ContractRegisterRule()
            _elem102.read(iprot)
            self.page.append(_elem102)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class ReqContractRegisterRuleOption:
      ...
      if fid == 1:
        if ftype == TType.SET:
          ...
          for _i115 in xrange(_size111):
            ...
            self.commodityIds.add(_elem116)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.commodityIds is not None:
      oprot.writeFieldBegin('commodityIds', TType.SET, 1)
      oprot.writeSetBegin(TType.I32, len(self.commodityIds))
      for iter117 in self.commodityIds:
...
class ReqQuotationAccountOption:
  ...
  def __init__(self, accountIds=None, platform=None, platformEnv=None, supportCommodityIds=None, brokerIds=None, accountNamePartical=None, nickNamePartical=None,):
    self.accountIds = accountIds
    self.platform = platform
    self.platformEnv = platformEnv
    self.supportCommodityIds = supportCommodityIds
      ...
      if fid == 1:
        ...
        if ftype == TType.SET:
          ...
          for _i128 in xrange(_size124):
            ...
            self.supportCommodityIds.add(_elem129)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.accountIds is not None:
      oprot.writeFieldBegin('accountIds', TType.SET, 1)
      oprot.writeSetBegin(TType.I64, len(self.accountIds))
      for iter136 in self.accountIds:
    ...
    if self.supportCommodityIds is not None:
      ...
      oprot.writeSetBegin(TType.I32, len(self.supportCommodityIds))
      for iter137 in self.supportCommodityIds:
