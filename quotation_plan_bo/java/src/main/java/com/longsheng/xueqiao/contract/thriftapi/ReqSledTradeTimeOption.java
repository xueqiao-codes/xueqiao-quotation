...
public class ReqSledTradeTimeOption implements org.apache.thrift.TBase<ReqSledTradeTimeOption, ReqSledTradeTimeOption._Fields>, java.io.Serializable, Cloneable, Comparable<ReqSledTradeTimeOption> {
  ...
  private _Fields optionals[] = {_Fields.SLED_COMMODITY_IDS,_Fields.DATE_TIMESTAMP,_Fields.DATE,_Fields.DAYS};
  ...
  public ReqSledTradeTimeOption setDate(String date) {
    this.date = date;
    return this;
  }
  ...
  public ReqSledTradeTimeOption setDays(int days) {
    this.days = days;
    setDaysIsSet(true);
    return this;
  }
