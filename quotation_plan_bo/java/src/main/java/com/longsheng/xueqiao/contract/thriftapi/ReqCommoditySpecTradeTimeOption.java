...
public class ReqCommoditySpecTradeTimeOption implements org.apache.thrift.TBase<ReqCommoditySpecTradeTimeOption, ReqCommoditySpecTradeTimeOption._Fields>, java.io.Serializable, Cloneable, Comparable<ReqCommoditySpecTradeTimeOption> {
        ...
        switch (schemeField.id) {
          case 1: // SLED_COMMODITY_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set608 = iprot.readSetBegin();
                struct.sledCommodityIds = new HashSet<Integer>(2*_set608.size);
                for (int _i609 = 0; _i609 < _set608.size; ++_i609)
                {
                  int _elem610;
                  _elem610 = iprot.readI32();
                  struct.sledCommodityIds.add(_elem610);
                }
                iprot.readSetEnd();
              }
      ...
      if (struct.sledCommodityIds != null) {
        if (struct.isSetSledCommodityIds()) {
          oprot.writeFieldBegin(SLED_COMMODITY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter611 : struct.sledCommodityIds)
            {
  ...
  private static class ReqCommoditySpecTradeTimeOptionTupleScheme extends TupleScheme<ReqCommoditySpecTradeTimeOption> {
      ...
      if (struct.isSetSledCommodityIds()) {
        {
          ...
          for (int _iter612 : struct.sledCommodityIds)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqCommoditySpecTradeTimeOption struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TSet _set613 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.sledCommodityIds = new HashSet<Integer>(2*_set613.size);
          for (int _i614 = 0; _i614 < _set613.size; ++_i614)
          {
            int _elem615;
            _elem615 = iprot.readI32();
            struct.sledCommodityIds.add(_elem615);
          }
        }
        struct.setSledCommodityIdsIsSet(true);
      }
