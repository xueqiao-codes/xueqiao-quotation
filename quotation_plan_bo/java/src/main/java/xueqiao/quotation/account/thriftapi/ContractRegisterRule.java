...
public class ContractRegisterRule implements org.apache.thrift.TBase<ContractRegisterRule, ContractRegisterRule._Fields>, java.io.Serializable, Cloneable, Comparable<ContractRegisterRule> {
  ...
  private _Fields optionals[] = {_Fields.SLED_COMMODITY_ID,_Fields.REGISTER_PRIORITY,_Fields.ACTIVE_SHOW_COUNT,_Fields.INACTIVE_SHOW_COUNT,_Fields.PLATFORM_ENV,_Fields.CREATE_TIMESTAMP,_Fields.LAST_MODITY_TIMESTAMP,_Fields.ORDER_INDEX,_Fields.ACTIVE_TYPE,_Fields.FIXED_CODE};
   ...
   * @see ContractActiveType
   */
  public ContractRegisterRule setActiveType(ContractActiveType activeType) {
  ...
  public ContractRegisterRule setFixedCode(String fixedCode) {
