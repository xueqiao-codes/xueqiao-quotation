            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<QuotationAccount>(_list180.size);
                for (int _i181 = 0; _i181 < _list180.size; ++_i181)
                {
                  QuotationAccount _elem182;
                  _elem182 = new QuotationAccount();
                  _elem182.read(iprot);
                  struct.page.add(_elem182);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (QuotationAccount _iter183 : struct.page)
            {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (QuotationAccount _iter184 : struct.page)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.page = new ArrayList<QuotationAccount>(_list185.size);
          for (int _i186 = 0; _i186 < _list185.size; ++_i186)
          {
            QuotationAccount _elem187;
            _elem187 = new QuotationAccount();
            _elem187.read(iprot);
            struct.page.add(_elem187);
          }
        }
        struct.setPageIsSet(true);
      }
