%module(directors="1") QuotationSubscriber
%{
...
extern "C" void JNI_OnUnload(JavaVM* vm, void* reserved) {
    ::xueqiao::quotation::swig::QuotationSubscriberSwig::destroy();
}
%}

#endif

%feature("director", assumeoverride=1) xueqiao::quotation::ISubscribeCallback;
%include "../api/subscribe_callback.h"

%include "subscribe_system_swig.h"
