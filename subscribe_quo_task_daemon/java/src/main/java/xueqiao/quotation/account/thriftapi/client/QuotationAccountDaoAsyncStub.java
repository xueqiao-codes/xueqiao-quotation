...
public class QuotationAccountDaoAsyncStub extends BaseStub { 
  ...
  public void send_notifySubscribeQuoteStateChange(int routeKey, int timeout) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_notifySubscribeQuoteStateChangeServiceCall(routeKey, timeout, platformArgs), new TRequestOption());
  }

  public void send_notifySubscribeQuoteStateChange(int routeKey, int timeout,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_notifySubscribeQuoteStateChangeServiceCall(routeKey, timeout, platformArgs), requestOption);
  }

  public long notifySubscribeQuoteStateChange(int routeKey, int timeout, IMethodCallback<QuotationAccountDao.notifySubscribeQuoteStateChange_args, QuotationAccountDao.notifySubscribeQuoteStateChange_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_notifySubscribeQuoteStateChangeServiceCall(routeKey, timeout, platformArgs), callback);
  }

  public long add_notifySubscribeQuoteStateChangeCall(AsyncCallRunner runner, int routeKey, int timeout, IMethodCallback<QuotationAccountDao.notifySubscribeQuoteStateChange_args, QuotationAccountDao.notifySubscribeQuoteStateChange_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_notifySubscribeQuoteStateChangeServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    QuotationAccountDao.notifySubscribeQuoteStateChange_args request = new QuotationAccountDao.notifySubscribeQuoteStateChange_args();
    request.setPlatformArgs(platformArgs);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("notifySubscribeQuoteStateChange");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(QuotationAccountDao.notifySubscribeQuoteStateChange_result.class);
    return serviceCall;
  }

  public void send_reqLatestSQSTask(int routeKey, int timeout) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_reqLatestSQSTaskServiceCall(routeKey, timeout, platformArgs), new TRequestOption());
  }

  public void send_reqLatestSQSTask(int routeKey, int timeout,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_reqLatestSQSTaskServiceCall(routeKey, timeout, platformArgs), requestOption);
  }

  public long reqLatestSQSTask(int routeKey, int timeout, IMethodCallback<QuotationAccountDao.reqLatestSQSTask_args, QuotationAccountDao.reqLatestSQSTask_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_reqLatestSQSTaskServiceCall(routeKey, timeout, platformArgs), callback);
  }

  public long add_reqLatestSQSTaskCall(AsyncCallRunner runner, int routeKey, int timeout, IMethodCallback<QuotationAccountDao.reqLatestSQSTask_args, QuotationAccountDao.reqLatestSQSTask_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_reqLatestSQSTaskServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    QuotationAccountDao.reqLatestSQSTask_args request = new QuotationAccountDao.reqLatestSQSTask_args();
    request.setPlatformArgs(platformArgs);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("reqLatestSQSTask");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(QuotationAccountDao.reqLatestSQSTask_result.class);
    return serviceCall;
  }

  public void send_removeEarlySQSTask(int routeKey, int timeout, long taskId) throws TException {
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_removeEarlySQSTaskServiceCall(routeKey, timeout, platformArgs, taskId), new TRequestOption());
  }

  public void send_removeEarlySQSTask(int routeKey, int timeout, long taskId,TRequestOption requestOption) throws TException { 
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    SvrContainer.getInstance().sendRequest(
        create_removeEarlySQSTaskServiceCall(routeKey, timeout, platformArgs, taskId), requestOption);
  }

  public long removeEarlySQSTask(int routeKey, int timeout, long taskId, IMethodCallback<QuotationAccountDao.removeEarlySQSTask_args, QuotationAccountDao.removeEarlySQSTask_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
    ...
    return SvrContainer.getInstance().sendRequest(
            create_removeEarlySQSTaskServiceCall(routeKey, timeout, platformArgs, taskId), callback);
  }

  public long add_removeEarlySQSTaskCall(AsyncCallRunner runner, int routeKey, int timeout, long taskId, IMethodCallback<QuotationAccountDao.removeEarlySQSTask_args, QuotationAccountDao.removeEarlySQSTask_result> callback) throws TException{
    PlatformArgs platformArgs = new PlatformArgs();
    platformArgs.setTimeoutMs(timeout);
    StackTraceElement callStackElement = Thread.currentThread().getStackTrace()[2];
    platformArgs.setSourceDesc(
  ...
  protected TServiceCall create_removeEarlySQSTaskServiceCall(int routeKey, int timeout, org.soldier.platform.svr_platform.comm.PlatformArgs platformArgs, long taskId){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
    ...
    serviceCall.setRouteKey(routeKey);
    serviceCall.setOneWay(false);
    QuotationAccountDao.removeEarlySQSTask_args request = new QuotationAccountDao.removeEarlySQSTask_args();
    request.setPlatformArgs(platformArgs);
    request.setTaskId(taskId);
    serviceCall.setRequest(request);
    serviceCall.setMethodName("removeEarlySQSTask");
    serviceCall.setTimeout(timeout);
    serviceCall.setResponse(QuotationAccountDao.removeEarlySQSTask_result.class);
    return serviceCall;
  }
