            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityIds = new ArrayList<Integer>(_list216.size);
                for (int _i217 = 0; _i217 < _list216.size; ++_i217)
                {
                  int _elem218;
                  _elem218 = iprot.readI32();
                  struct.sledCommodityIds.add(_elem218);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.sledCommodityIds != null) {
        if (struct.isSetSledCommodityIds()) {
          oprot.writeFieldBegin(SLED_COMMODITY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter219 : struct.sledCommodityIds)
            {
      ...
      if (struct.isSetSledCommodityIds()) {
        {
          ...
          for (int _iter220 : struct.sledCommodityIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.sledCommodityIds = new ArrayList<Integer>(_list221.size);
          for (int _i222 = 0; _i222 < _list221.size; ++_i222)
          {
            int _elem223;
            _elem223 = iprot.readI32();
            struct.sledCommodityIds.add(_elem223);
          }
        }
        struct.setSledCommodityIdsIsSet(true);
      }
