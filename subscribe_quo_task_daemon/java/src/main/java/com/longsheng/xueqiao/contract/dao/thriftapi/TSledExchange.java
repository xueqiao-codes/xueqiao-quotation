...
public class TSledExchange implements org.apache.thrift.TBase<TSledExchange, TSledExchange._Fields>, java.io.Serializable, Cloneable, Comparable<TSledExchange> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TSledExchange");
  ...
  private static final org.apache.thrift.protocol.TField CN_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("cnName", org.apache.thrift.protocol.TType.STRING, (short)13);
  private static final org.apache.thrift.protocol.TField CN_ACRONYM_FIELD_DESC = new org.apache.thrift.protocol.TField("cnAcronym", org.apache.thrift.protocol.TType.STRING, (short)14);
  ...
  private static final org.apache.thrift.protocol.TField TIME_LAG_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("timeLagMs", org.apache.thrift.protocol.TType.I64, (short)17);
  ...
  static {
    schemes.put(StandardScheme.class, new TSledExchangeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSledExchangeTupleSchemeFactory());
  }
  ...
  public int operatingMicType; // optional
  ...
  public long timeLagMs; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    CN_NAME((short)13, "cnName"),
    CN_ACRONYM((short)14, "cnAcronym"),
    ZONE_ID((short)16, "zoneId"),
    TIME_LAG_MS((short)17, "timeLagMs"),
  ...
  private static final int __OPERATINGMICTYPE_ISSET_ID = 1;
  private static final int __TIMELAGMS_ISSET_ID = 2;
  private static final int __ACTIVESTARTTIMESTAMP_ISSET_ID = 3;
  private static final int __ACTIVEENDTIMESTAMP_ISSET_ID = 4;
  private static final int __CREATETIMESTAMP_ISSET_ID = 5;
  private static final int __LASTMODITYTIMESTAMP_ISSET_ID = 6;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.SLED_EXCHANGE_ID,_Fields.EXCHANGE_MIC,_Fields.COUNTRY,_Fields.COUNTRY_CODE,_Fields.OPERATING_MIC,_Fields.OPERATING_MIC_TYPE,_Fields.NAME_INSTITUTION,_Fields.ACRONYM,_Fields.CITY,_Fields.WEBSITE,_Fields.CN_NAME,_Fields.CN_ACRONYM,_Fields.ZONE_ID,_Fields.TIME_LAG_MS,_Fields.ACTIVE_START_TIMESTAMP,_Fields.ACTIVE_END_TIMESTAMP,_Fields.CREATE_TIMESTAMP,_Fields.LAST_MODITY_TIMESTAMP};
  ...
  static {
    ...
    tmpMap.put(_Fields.ZONE_ID, new org.apache.thrift.meta_data.FieldMetaData("zoneId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.TIME_LAG_MS, new org.apache.thrift.meta_data.FieldMetaData("timeLagMs", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TSledExchange.class, metaDataMap);
  }

  public TSledExchange() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TSledExchange(TSledExchange other) {
    ...
    this.timeLagMs = other.timeLagMs;
  ...
  public TSledExchange deepCopy() {
    return new TSledExchange(this);
  }
  ...
  public void clear() {
    ...
    setOperatingMicTypeIsSet(false);
    this.operatingMicType = 0;
  ...
  public TSledExchange setSledExchangeId(int sledExchangeId) {
  ...
  public TSledExchange setExchangeMic(String exchangeMic) {
  ...
  public TSledExchange setCountry(String country) {
  ...
  public TSledExchange setCountryCode(String countryCode) {
  ...
  public TSledExchange setOperatingMic(String operatingMic) {
  ...
  public int getOperatingMicType() {
    return this.operatingMicType;
  }

  public TSledExchange setOperatingMicType(int operatingMicType) {
    this.operatingMicType = operatingMicType;
    setOperatingMicTypeIsSet(true);
    return this;
  }

  public void unsetOperatingMicType() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __OPERATINGMICTYPE_ISSET_ID);
  }
  ...
  public boolean isSetOperatingMicType() {
    return EncodingUtils.testBit(__isset_bitfield, __OPERATINGMICTYPE_ISSET_ID);
  }

  public void setOperatingMicTypeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __OPERATINGMICTYPE_ISSET_ID, value);
  }
  ...
  public TSledExchange setNameInstitution(String nameInstitution) {
  ...
  public TSledExchange setAcronym(String acronym) {
  ...
  public TSledExchange setCity(String city) {
    this.city = city;
    return this;
  }
  ...
  public TSledExchange setWebsite(String website) {
  ...
  public TSledExchange setCnName(String cnName) {
    this.cnName = cnName;
    return this;
  }
  ...
  public TSledExchange setCnAcronym(String cnAcronym) {
  ...
  public TSledExchange setZoneId(String zoneId) {
    this.zoneId = zoneId;
    return this;
  }
  ...
  public long getTimeLagMs() {
    return this.timeLagMs;
  }

  public TSledExchange setTimeLagMs(long timeLagMs) {
    this.timeLagMs = timeLagMs;
    setTimeLagMsIsSet(true);
    return this;
  }

  public void unsetTimeLagMs() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TIMELAGMS_ISSET_ID);
  }

  /** Returns true if field timeLagMs is set (has been assigned a value) and false otherwise */
  public boolean isSetTimeLagMs() {
    return EncodingUtils.testBit(__isset_bitfield, __TIMELAGMS_ISSET_ID);
  }

  public void setTimeLagMsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TIMELAGMS_ISSET_ID, value);
  }
  ...
  public TSledExchange setActiveStartTimestamp(long activeStartTimestamp) {
  ...
  public TSledExchange setActiveEndTimestamp(long activeEndTimestamp) {
  ...
  public TSledExchange setCreateTimestamp(long createTimestamp) {
  ...
  public TSledExchange setLastModityTimestamp(long lastModityTimestamp) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case OPERATING_MIC_TYPE:
      if (value == null) {
        ...
        setOperatingMicType((Integer)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case OPERATING_MIC_TYPE:
      return Integer.valueOf(getOperatingMicType());
    ...
    case TIME_LAG_MS:
      return Long.valueOf(getTimeLagMs());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TSledExchange)
      return this.equals((TSledExchange)that);
    return false;
  }

  public boolean equals(TSledExchange that) {
    if (that == null)
      return false;
    ...
    if (this_present_operatingMicType || that_present_operatingMicType) {
      if (!(this_present_operatingMicType && that_present_operatingMicType))
        return false;
      if (this.operatingMicType != that.operatingMicType)
        return false;
    }
    ...
    boolean this_present_timeLagMs = true && this.isSetTimeLagMs();
    boolean that_present_timeLagMs = true && that.isSetTimeLagMs();
    if (this_present_timeLagMs || that_present_timeLagMs) {
      if (!(this_present_timeLagMs && that_present_timeLagMs))
        return false;
      if (this.timeLagMs != that.timeLagMs)
        return false;
    }
  ...
  @Override
  public int compareTo(TSledExchange other) {
    ...
    lastComparison = Boolean.valueOf(isSetTimeLagMs()).compareTo(other.isSetTimeLagMs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTimeLagMs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.timeLagMs, other.timeLagMs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TSledExchange(");
    boolean first = true;
  ...
  private static class TSledExchangeStandardSchemeFactory implements SchemeFactory {
    public TSledExchangeStandardScheme getScheme() {
      return new TSledExchangeStandardScheme();
    }
  }

  private static class TSledExchangeStandardScheme extends StandardScheme<TSledExchange> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TSledExchange struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // OPERATING_MIC_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.operatingMicType = iprot.readI32();
          ...
          case 17: // TIME_LAG_MS
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.timeLagMs = iprot.readI64();
              struct.setTimeLagMsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSledExchange struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.isSetOperatingMicType()) {
        ...
        oprot.writeI32(struct.operatingMicType);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.isSetTimeLagMs()) {
        oprot.writeFieldBegin(TIME_LAG_MS_FIELD_DESC);
        oprot.writeI64(struct.timeLagMs);
        oprot.writeFieldEnd();
      }
  ...
  private static class TSledExchangeTupleSchemeFactory implements SchemeFactory {
    public TSledExchangeTupleScheme getScheme() {
      return new TSledExchangeTupleScheme();
    }
  }

  private static class TSledExchangeTupleScheme extends TupleScheme<TSledExchange> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TSledExchange struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TSledExchange struct) throws org.apache.thrift.TException {
