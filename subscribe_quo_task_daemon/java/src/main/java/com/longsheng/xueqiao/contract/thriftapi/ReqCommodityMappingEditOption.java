            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityIdList = new ArrayList<Integer>(_list64.size);
                for (int _i65 = 0; _i65 < _list64.size; ++_i65)
                {
                  int _elem66;
                  _elem66 = iprot.readI32();
                  struct.sledCommodityIdList.add(_elem66);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mapIds = new ArrayList<Integer>(_list67.size);
                for (int _i68 = 0; _i68 < _list67.size; ++_i68)
                {
                  int _elem69;
                  _elem69 = iprot.readI32();
                  struct.mapIds.add(_elem69);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.sledCommodityIdList != null) {
        if (struct.isSetSledCommodityIdList()) {
          oprot.writeFieldBegin(SLED_COMMODITY_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter70 : struct.sledCommodityIdList)
            {
      ...
      if (struct.isSetSledCommodityIdList()) {
        {
          ...
          for (int _iter72 : struct.sledCommodityIdList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.sledCommodityIdList = new ArrayList<Integer>(_list74.size);
          for (int _i75 = 0; _i75 < _list74.size; ++_i75)
          {
            int _elem76;
            _elem76 = iprot.readI32();
            struct.sledCommodityIdList.add(_elem76);
          }
        }
        struct.setSledCommodityIdListIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.mapIds = new ArrayList<Integer>(_list77.size);
          for (int _i78 = 0; _i78 < _list77.size; ++_i78)
          {
            int _elem79;
            _elem79 = iprot.readI32();
            struct.mapIds.add(_elem79);
          }
        }
        struct.setMapIdsIsSet(true);
      }
