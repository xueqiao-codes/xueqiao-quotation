...
public class SpecTradeTime implements org.apache.thrift.TBase<SpecTradeTime, SpecTradeTime._Fields>, java.io.Serializable, Cloneable, Comparable<SpecTradeTime> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityIds = new ArrayList<Integer>(_list576.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityTypes = new ArrayList<String>(_list579.size);
                for (int _i580 = 0; _i580 < _list579.size; ++_i580)
                {
                  String _elem581;
                  _elem581 = iprot.readString();
                  struct.sledCommodityTypes.add(_elem581);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityNames = new ArrayList<String>(_list582.size);
                for (int _i583 = 0; _i583 < _list582.size; ++_i583)
                {
                  String _elem584;
                  _elem584 = iprot.readString();
                  struct.sledCommodityNames.add(_elem584);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.sledCommodityIds != null) {
        if (struct.isSetSledCommodityIds()) {
          oprot.writeFieldBegin(SLED_COMMODITY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter585 : struct.sledCommodityIds)
            {
      ...
      if (struct.sledCommodityTypes != null) {
        if (struct.isSetSledCommodityTypes()) {
          oprot.writeFieldBegin(SLED_COMMODITY_TYPES_FIELD_DESC);
          {
            ...
            for (String _iter586 : struct.sledCommodityTypes)
            {
      ...
      if (struct.sledCommodityNames != null) {
        if (struct.isSetSledCommodityNames()) {
          oprot.writeFieldBegin(SLED_COMMODITY_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter587 : struct.sledCommodityNames)
            {
  ...
  private static class SpecTradeTimeTupleScheme extends TupleScheme<SpecTradeTime> {
      ...
      if (struct.isSetSledCommodityIds()) {
        {
          ...
          for (int _iter588 : struct.sledCommodityIds)
          {
      ...
      if (struct.isSetSledCommodityTypes()) {
        {
          ...
          for (String _iter589 : struct.sledCommodityTypes)
          {
      ...
      if (struct.isSetSledCommodityNames()) {
        {
          ...
          for (String _iter590 : struct.sledCommodityNames)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SpecTradeTime struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list591 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.sledCommodityIds = new ArrayList<Integer>(_list591.size);
          for (int _i592 = 0; _i592 < _list591.size; ++_i592)
          {
            int _elem593;
            _elem593 = iprot.readI32();
            struct.sledCommodityIds.add(_elem593);
          }
        }
        struct.setSledCommodityIdsIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list594 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.sledCommodityTypes = new ArrayList<String>(_list594.size);
          for (int _i595 = 0; _i595 < _list594.size; ++_i595)
          {
            String _elem596;
            _elem596 = iprot.readString();
            struct.sledCommodityTypes.add(_elem596);
          }
        }
        struct.setSledCommodityTypesIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.sledCommodityNames = new ArrayList<String>(_list597.size);
          for (int _i598 = 0; _i598 < _list597.size; ++_i598)
          {
            String _elem599;
            _elem599 = iprot.readString();
            struct.sledCommodityNames.add(_elem599);
          }
        }
        struct.setSledCommodityNamesIsSet(true);
      }
